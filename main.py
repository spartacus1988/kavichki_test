...
__author__ = 'katriniya'

'''
Please note - this is a test task for the company "Кавычки". 
My deep conviction is that any work must be paid. Business 
carries risks when hiring staff. This is part of the cost 
of the product and no one has the right to transfer them 
to the workers. I ask all interested developers to 
distribute and use this script.
'''
...
conn = mysql.connect(HOST_DB, USER_DB, PASSWD_US, charset='utf8') 
